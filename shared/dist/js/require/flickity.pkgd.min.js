    ...
    function s(l, h, c) {
        ...
        c.fn[l] = function(t) {
            if ("string" != typeof t)
                ...
                this;
            var n, s, o, r, a, e = i.call(arguments, 1);
            return s = e,
            r = "$()." + l + '("' + (n = t) + '")',
            (t = this).each(function(t, e) {
                var i = c.data(e, l);
                i ? (e = i[n]) && "_" != n.charAt(0) ? (i = e.apply(i, s),
                o = void 0 === o ? i : o) : d(r + " is not a valid method") : d(l + " not initialized. Cannot call methods, i.e. " + r)
            }),
            void 0 !== o ? o : t
        }
        ,
...
function(t, e) {
    ...
    function b(t) {
        ...
        (t = "string" == typeof t ? document.querySelector(t) : t) && "object" == typeof t && t.nodeType) {
            ...
            for (var n = i.isBorderBox = "border-box" == e.boxSizing, s = 0; s < g; s++) {
                var o = p[s]
                  , r = e[o]
                  , r = parseFloat(r);
                i[o] = isNaN(r) ? 0 : r
...
function(r, a) {
    ...
    }) : "object" == typeof module && module.exports ? module.exports = a(r, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./cell"), require("./slide"), require("./animate")) : (t = r.Flickity,
    r.Flickity = a(r, r.EvEmitter, r.getSize, r.fizzyUIUtils, t.Cell, t.Slide, t.animatePrototype))
}(window, function(n, t, e, r, i, a, s) {
    var o = n.jQuery
    ...
    p.updateSlides = function() {
        ...
        this.cells.forEach(function(t, e) {
            var i;
            n.cells.length && (i = n.outerWidth - n.firstMargin + (t.size.outerWidth - t.size[s]),
    ...
    p._containSlides = function() {
        ...
        this.slides.forEach(function(t) {
            n ? t.target = i * this.cellAlign : (t.target = Math.max(t.target, s),
    ...
    p.dispatchEvent = function(t, e, i) {
        ...
        this.emitEvent(t, n),
        o && this.$element && (n = t += this.options.namespaceJQueryEvents ? ".flickity" : "",
        e && ((e = o.Event(e)).type = t,
        n = e),
    ...
    p.select = function(t, e, i) {
        ...
        this._wrapSelect(t),
        (this.options.wrapAround || e) && (t = r.modulo(t, this.slides.length)),
    ...
    p._wrapSelect = function(t) {
        ...
        !this.isDragSelect && s < n ? t += e : !this.isDragSelect && i < n && (t -= e),
    ...
    p.getParentCell = function(t) {
        ...
        return e || (t = r.getParent(t, ".flickity-slider > *"),
        this.getCell(t))
    }
    ,
...
function(n, s) {
    ...
    n.dragMove = function(t, e, i) {
        ...
        !this.options.wrapAround && this.slides.length && (n = (n = (s = Math.max(-this.slides[0].target, this.dragStartPosition)) < n ? .5 * (n + s) : n) < (s = Math.min(-this.getLastSlide().target, this.dragStartPosition)) ? .5 * (n + s) : n),
        this.dragX = n,
...
function(t, n) {
    ...
    o.prototype.createSVG = function() {
        ...
        var e, i = document.createElementNS(s, "path"), e = "string" != typeof (e = this.parent.options.arrowShape) ? "M " + e.x0 + ",50 L " + e.x1 + "," + (e.y1 + 50) + " L " + e.x2 + "," + (e.y2 + 50) + " L " + e.x3 + ",50  L " + e.x2 + "," + (50 - e.y2) + " L " + e.x1 + "," + (50 - e.y1) + " Z" : e;
...
function(t, i) {
    ...
    return i.insert = function(t, e) {
        ...
        r && r.length && (o = this.cells.length,
        e = void 0 === e ? o : e,
        s = r,
        ...
        i = n,
        (t = e == o) ? this.slider.appendChild(i) : (s = this.cells[e].element,
        this.slider.insertBefore(i, s)),
        0 === e ? this.cells = r.concat(this.cells) : t ? this.cells = this.cells.concat(r) : (o = this.cells.splice(e, o - e),
        this.cells = this.cells.concat(r).concat(o)),
        this._sizeCells(r),
        this.cellChange(e, !0))
    }
    ,
...
function(e, i) {
    ...
    function h(t, e, i) {
        if (!(this instanceof h))
            return new h(t,e,i);
        var n, s = t;
        (s = "string" == typeof t ? document.querySelectorAll(t) : s) ? (this.elements = (n = s,
